...
export const metadata: Metadata = {
  title: "NAAZ (ناز) — Premium Women's Handbags & Accessories Pakistan",
  description:
    "Discover Pakistan's finest collection of luxury handbags, shoulder bags, totes, clutches, pouches & wallets with Cash on Delivery across Pakistan.",
}
